      ...
      <div className="flex">
        ...
        <main className="flex-1 ml-64 transition-all duration-300 py-8">
          <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="relative">
              ...
              <div className="space-y-12">
                {timelineEvents.map((event, idx) => (
                  ...
                  >
                    {/* Timeline node */}
                    <div className="absolute -left-3 top-6 w-6 h-6 rounded-full bg-gradient-to-br from-indigo-500 to-cyan-400 border-4 border-background" />
                    ...
                    <div className="glass-card p-6">
                      <div className="flex items-start justify-between mb-4">
                        <div>
                          ...
                          <p className="text-slate-400 mb-3">{event.scientist}</p>
                        </div>
            ...
            {/* Add more historical events button */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
