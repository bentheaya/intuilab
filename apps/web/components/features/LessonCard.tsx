...
export default function LessonCard({
  ...
  return (
    ...
    >
      <Link href={href}>
        <div className="glass relative p-6 cursor-pointer group h-full rounded-xl">
          {/* Subject Gradient Background */}
          <div className={`absolute inset-0 opacity-0 group-hover:opacity-20 rounded-xl bg-gradient-to-br ${subjectColors[subject]} transition-opacity duration-300`} />
