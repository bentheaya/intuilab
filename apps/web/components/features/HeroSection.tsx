    ...
    >
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <motion.div variants={itemVariants} className="mb-8">
          <div className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full bg-gradient-to-r from-indigo-500/20 to-cyan-400/20 border border-indigo-400/30 text-sm font-medium text-cyan-200 mx-auto mb-4">
        ...
        <motion.h1 variants={itemVariants} className="mb-6">
          <span className="block text-4xl md:text-6xl lg:text-7xl font-bold leading-tight mb-4 text-white">
            Rediscover Science
          </span>
        ...
        {/* Subheading */}
        <motion.p variants={itemVariants} className="text-lg md:text-xl text-zinc-300 mb-8 max-w-2xl mx-auto leading-relaxed">
