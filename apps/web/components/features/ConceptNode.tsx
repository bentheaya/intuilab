    ...
    >
      ...
      <div
        className={`relative w-20 h-20 rounded-full flex items-center justify-center border-2 transition-all ${
          mastered
            ? 'bg-gradient-to-br from-emerald-500/20 to-cyan-400/10 border-emerald-400 shadow-lg shadow-emerald-500/20'
            : locked
      ...
      <p className={`mt-4 text-sm font-medium text-center max-w-24 leading-tight transition-colors ${
        mastered ? 'text-emerald-300' : 'text-zinc-200 group-hover:text-cyan-300'
      }`}>
        {label}
      </p>
