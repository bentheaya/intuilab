...
import { Users, MessageCircle, Pen, Share2 } from 'lucide-react'
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          >
            ...
            {/* Canvas */}
            <div className="bg-zinc-900/50 border-2 border-cyan-400/30 rounded-lg aspect-video mb-6 flex items-center justify-center relative overflow-hidden group">
              ...
              {collaborators.map((collab, idx) => (
                ...
                >
                  ...
                  <div className="text-xs text-zinc-400 mt-1 bg-zinc-800/80 px-2 py-1 rounded whitespace-nowrap">
                    {collab.name}
                  </div>
                </motion.div>
              ))}
            ...
            <div className="flex items-center gap-2">
              <button className="p-2 rounded-lg hover:bg-zinc-700/40 transition-all text-zinc-300 hover:text-cyan-300">✏️</button>
              <button className="p-2 rounded-lg hover:bg-zinc-700/40 transition-all text-zinc-300 hover:text-cyan-300">📐</button>
              <button className="p-2 rounded-lg hover:bg-zinc-700/40 transition-all text-zinc-300 hover:text-cyan-300">∑</button>
          ...
          >
            ...
            {/* AI Moderator */}
            <div className="glass rounded-xl p-4 bg-gradient-to-br from-cyan-500/10 to-indigo-500/10 border-cyan-400/20">
              ...
              <p className="text-xs text-zinc-400">Active & Monitoring</p>
            </div>

            {/* Room Stats */}
            <div className="glass rounded-xl p-4 space-y-2">
              {[['Session Time', '12:45'], ['Messages', '24'], ['Annotations', '8']].map(([label, value]) => (
        ...
        >
          ...
          <div className="flex gap-3">
            <input
              ...
              className="flex-1 px-4 py-2 rounded-lg bg-zinc-800/50 border border-zinc-700/50 text-white placeholder-zinc-500 focus:outline-none focus:border-cyan-400/50 transition-colors"
            />
